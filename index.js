...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'james md'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: james`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: jtechde`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} number: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: james`))
            console.log(chalk.green(`${global.themeemoji || '•'} 🤖 james md connected! ✅`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
